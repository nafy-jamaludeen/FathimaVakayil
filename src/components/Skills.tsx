...
export default function Skills() {
  const skillSets: SkillCategory[] = [
    {
      id: "ece",
      title: "Early Childhood & Foundational",
      description: "Expertise in designing challenging and enjoyable classroom experiences for early cohorts (KG1 & KG2). Specializes in innovative pedagogical approaches, child development milestone tracking, and fostering high cognitive, social, and emotional growth.",
      iconName: "Puzzle",
      tags: ["KG1 & KG2 Development", "Child Psychology", "Classroom Organization", "Continuous Growth"]
    },
    {
      id: "curr",
      title: "Pedagogical Design & Curriculum",
      description: "Proficient in collaborative curriculum development and formulation of the Annual Curriculum Plan (ACP). Expertise in technology integration, creating customized lesson plans, and early years parent-facing educational newsletters.",
      iconName: "BookOpen",
      tags: ["Annual Curriculum Plan", "Custom Lesson Design", "Technology Integration", "Parent Connection"]
    },
    {
      id: "student",
      title: "Assessment & Development",
      description: "Exceptional proficiency in both formative and summative assessment strategies. Specializes in critical analysis of student progress, interventions, behavioral self-regulation, and differentiated learning style accommodations.",
      iconName: "UserCheck",
      tags: ["Formative Strategy", "Summative Milestones", "EAL Accommodation", "Self-Regulation"]
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-5 text-left">
            ...
            <h2 className="font-display text-[2.5rem] md:text-[4rem] leading-none text-brand-offwhite tracking-tight animate-fade-in">
              Sustainably <span className="font-display italic text-brand-mint font-normal">engineered</span> competencies.
            </h2>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  {/* Title */}
                  <h3 className="font-display text-2xl font-semibold text-brand-offwhite mb-4 group-hover:text-brand-mint transition-colors duration-300">
                    {skill.title}
                  </h3>
        ...
        <div className="mt-16 bg-gradient-to-r from-[#021C1B] via-[#1f4d3a]/60 to-[#021C1B] text-brand-offwhite p-8 md:p-12 border border-white/15 rounded-2xl relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-8 shadow-2xl">
          ...
          <div className="relative group overflow-hidden max-w-[280px] w-full aspect-square rounded-2xl border border-white/10 shadow-2xl text-left bg-[#1F4D3A]/20 backdrop-blur-md p-2 shrink-0 z-10 transition-all duration-500 hover:scale-[1.03] hover:border-brand-mint/30">
            <img 
              ...
              alt="Organic class materials of Fathima Vakkayil" 
