...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full my-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center relative z-10 py-8">
        ...
        >
          ...
          <div className="relative overflow-visible mb-2">
            <motion.h1 
              variants={itemVariants}
              className="font-display text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[9.5rem] leading-[0.9] font-normal text-brand-offwhite tracking-tight z-10"
            >
              Fathima
            </motion.h1>
          </div>

          <div className="relative overflow-visible pb-4 md:pb-6 mb-2 md:mb-0 flex flex-wrap items-baseline gap-x-4">
            <motion.h1 
              variants={itemVariants}
              className="font-display italic text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[9.5rem] leading-[0.9] font-normal tracking-tight text-transparent stroke-text z-10 mr-2"
            >
              Vakayil
            </motion.h1>
          </div>
          ...
          <div className="relative w-full max-w-[320px] aspect-[4/5] bg-[#1F4D3A]/30 rounded-t-[160px] border border-white/10 p-3 flex flex-col justify-between overflow-hidden shadow-2xl transition-all duration-500 hover:scale-[1.03] hover:border-brand-mint/30">
            ...
            <div className="absolute inset-0 w-full h-full p-2">
              <img 
                ...
                alt="Fathima Vakkayil creative class style" 
            ...
            <div className="relative z-20 mt-auto p-4 text-center bg-[#1F4D3A]/90 backdrop-blur-md rounded-xl border border-white/10 shadow-lg">
              <span className="font-serif text-base font-semibold text-brand-mint mb-1 block">Modern Pedagogy</span>
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 flex justify-end items-center text-xs mt-4">
        <button
