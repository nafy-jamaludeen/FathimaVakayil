    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          >
            <span className="font-display text-xl md:text-2xl font-bold tracking-wide text-brand-offwhite transition-colors duration-300 group-hover:text-brand-mint">
              Fathima Vakayil
            </span>
