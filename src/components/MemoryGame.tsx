    ...
    >
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <h2 className="font-display text-[2.5rem] md:text-[3.5rem] leading-none text-brand-offwhite tracking-tight mb-4">
            Curated Discovery <span className="font-display italic text-brand-mint font-normal">Playground</span>
          </h2>
