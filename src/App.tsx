...
export default function App() {
  ...
  return (
    <div 
      id="portfolio-root"
      className="min-h-screen bg-brand-dark text-brand-offwhite flex flex-col relative w-full max-w-full overflow-x-hidden selection:bg-brand-mint selection:text-brand-dark"
    >
      {/* 3D Animated Scenic Background synced with brand colors */}
      <ScenicBackground />
